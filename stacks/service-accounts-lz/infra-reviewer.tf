...
resource "google_service_account_iam_binding" "infra_reviewer_workload_identity_user" {
  ...
  members = [
    ...
    "principalSet://iam.googleapis.com/${var.github_workload_identity_pool}/attribute.repository_base_ref_job_workflow_ref/${repo}/${var.main_branch}/${var.review_workflow}"
  ]
}
